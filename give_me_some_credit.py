...
Original file is located at
    https://colab.research.google.com/github/wjung1008/Give-Me-Some-Credit/blob/main/Give_me_some_Credit.ipynb
...
*   Here, Random Forest and simple deep learning model will be compared.
